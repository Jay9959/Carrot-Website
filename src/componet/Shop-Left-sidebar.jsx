                                    ...
                                    <Row>
                                        <Col>
                                            <Card className="p-3 mt-5" style={{ width: '13rem' }}>
                                                <div className="position-relative">
                                                    <Card.Img variant="top" src={Styl4} className="border rounded-3" />
                                                </div>
                                        ...
                                        <Col>
                                            <Card className="p-3 mt-5" style={{ width: '13rem' }}>
                                                ...
                                                <div className="position-relative">
                                                    <Card.Img variant="top" src={image13} className="border rounded-3" />
                                                </div>
                                        ...
                                        <Col>
                                            <Card className="p-3 mt-5" style={{ width: '13rem' }}>
                                                ...
                                                <div className="position-relative">
                                                    <Card.Img variant="top" src={image11} className="border rounded-3" />
                                                </div>
                                        ...
                                        <Col>
                                            <Card className="p-3 mt-5" style={{ width: '13rem' }}>
                                                ...
                                                <div className="position-relative">
                                                    <Card.Img variant="top" src={image12} className="border rounded-3" />
                                                </div>
